...
public class CommentController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		}else if(param.equals("MustdeleteAf")) {
	    ...
	    //	req.getRequestDispatcher("TpList?param=tp_list_detail&seq="+commListSeq);
		...
		} else if(param.equals("MatchdeleteAf")) {
			...
			CommentDao Cdao = CommentDao.getInstance();
			boolean deletechk = Cdao.deletecomment(commNum);
			
			resp.sendRedirect("match?param=matchdetail&seq="+commListSeq);
