				...
				<!-- 카드 시작 -->
						<div class="col-xl-9 col-lg-8 col-md-7 col-sm-12 col-12">
							<div class="section-head text-center" align="center">
								...
								<h2 class="title-head">Best List</h2>
...
%>
							...
							<div class="" style="margin-bottom: 0px; margin-top: 0px">
								...
								<section class="gallery-block cards-gallery" style="padding-top: 0px" >
								    <div class="container">
								        <div class="heading">
								          <!-- <h2>Cards Gallery</h2> -->
								        </div>
										...
										<!-- 	<h6>What about this</h6> -->
						                   ...
						                   <div class="col-md-6 col-lg-4" style="width: 350px; height: 300px; margin-bottom: 100px" >
						                       <div class="card border-0 transform-on-hover" style="height: 400px;">
						                     
						                         <a class="lightbox" href="./upload/${dto.newFilename }" > 
						                            <img  style="width: 250px; height: 200px; " src="./upload/${dto.newFilename}" alt="Card Image"   class="img-fluid image scale-on-hover" >
						                        	
						                        	<div class="card-body">
						                        	<span class="description" onclick="TpList?param=tp_list_detail&seq=${dto.seq}"></span>
						                            <span onclick="location.href='TpList?param=tp_list_detail&seq=${dto.seq}'" class="description-heading"  style="font-size: 23px">${i.index + 1}위
						                            <hr>${dto.place}<br>
						                            </span>
						                            <span class="description-body" style="font-size: 15px">${dto.title}</span>
						                     		</div>
							...
							<div class="side-bar p-l30 sticky-top">
								<h6 class="widget-title"><span>search</span></h6>
										...
										<form class="form-inline my-2 my-lg-0">
						                    <input style="width:110px" class="form-control mr-sm-2" id="search" type="text" placeholder="Search"
						                    value="${search }">
